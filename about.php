...
$pageMetaDescription = 'NovaCreator Studio - новое digital-агентство с большим опытом команды. Мишкин Виктор и Амири Искандер. Работаем онлайн, помогаем бизнесу расти в интернете. Опыт работы с motorland.kz.';
    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div class="animate-on-scroll">
                ...
                <p class="text-lg text-gray-400 mb-6 leading-relaxed">
                    Хотя мы новая компания, каждый из нас имеет многолетний опыт работы в digital-сфере. 
                    Среди наших успешных проектов — работа с <strong class="text-neon-purple">motorland.kz</strong>, 
                    где мы продемонстрировали свой профессионализм и достигли отличных результатов. 
                    Мы объединили свои знания и навыки, чтобы создать агентство, которое помогает 
