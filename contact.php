...
$pageMetaDescription = 'Свяжитесь с NovaCreator Studio. Телефон: +7 706 606 39 21, Email: victhewise@icloud.com. Работаем каждый день, онлайн по всему миру. Бесплатная консультация.';
    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="animate-on-scroll">
                <h2 class="text-4xl md:text-5xl font-bold mb-8 text-gradient">Контактная информация</h2>
                
                <div class="space-y-8 mb-12">
                    <!-- Email -->
                    <div class="flex items-start space-x-4">
                        <div class="w-12 h-12 bg-gradient-to-r from-neon-purple to-neon-blue rounded-lg flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                            ...
                            <a href="mailto:victhewise@icloud.com" class="text-gray-400 hover:text-neon-purple transition-colors">
                    ...
                    <!-- Телефон -->
                    <div class="flex items-start space-x-4">
                        <div class="w-12 h-12 bg-gradient-to-r from-neon-blue to-neon-purple rounded-lg flex items-center justify-center flex-shrink-0">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                            </svg>
                        </div>
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-gradient">Телефон</h3>
                            <a href="tel:+77066063921" class="text-gray-400 hover:text-neon-purple transition-colors">
                                +7 706 606 39 21
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div>
                            <h3 class="text-xl font-bold mb-2 text-gradient">Время работы</h3>
                ...
                <!-- Социальные сети -->
                <div>
                    <h3 class="text-xl font-bold mb-4 text-gradient">Мы в соцсетях</h3>
                    <div class="flex space-x-4">
                        <a href="#" class="w-12 h-12 bg-dark-surface border border-dark-border rounded-lg flex items-center justify-center hover:border-neon-purple hover:text-neon-purple transition-all duration-300">
            ...
            <div class="animate-on-scroll" style="animation-delay: 0.2s;">
                <div class="bg-dark-surface border border-dark-border rounded-2xl p-8">
                    <h2 class="text-3xl font-bold mb-8 text-gradient">Отправить заявку</h2>
                    
                    <form class="contact-form space-y-6" method="POST" action="<?php echo url('backend/send.php'); ?>">
