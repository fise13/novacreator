...
$pageMetaTitle = 'Google Ads - Настройка и ведение контекстной рекламы | NovaCreator Studio';
$pageMetaDescription = 'Настройка и ведение рекламных кампаний в Google Ads под ключ. Создание объявлений, работа с ключевыми словами, оптимизация для максимального ROI. Результаты: +45% CTR, +120% конверсий.';
$pageMetaKeywords = 'Google Ads, контекстная реклама, настройка Google Ads, реклама в Google, контекстная реклама под ключ, PPC реклама, ведение рекламных кампаний';
    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center animate-on-scroll">
            ...
            <h1 class="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
                <span class="text-gradient">Google Ads</span>
            </h1>
...
<section class="py-20">
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            <h2 class="text-4xl md:text-5xl font-bold mb-6 text-gradient">Что включает наша работа</h2>
            <p class="text-xl text-gray-400 max-w-3xl mx-auto">
                Полный цикл настройки и ведения рекламных кампаний в Google
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="service-card animate-on-scroll">
                ...
                <h3 class="text-2xl font-bold mb-4 text-gradient">Настройка кампаний</h3>
                <p class="text-gray-400 mb-4">
                    Создаем рекламные кампании с нуля с учетом специфики вашего бизнеса 
                    и целевой аудитории.
                </p>
                <ul class="space-y-2 text-sm text-gray-500">
                    <li>• Поисковые кампании</li>
                    <li>• РСЯ (Рекламная сеть Яндекса)</li>
                    <li>• Ретаргетинг</li>
                    <li>• Ремаркетинг</li>
                </ul>
            </div>
            ...
            <div class="service-card animate-on-scroll" style="animation-delay: 0.1s;">
                ...
                <h3 class="text-2xl font-bold mb-4 text-gradient">Ключевые слова</h3>
                <p class="text-gray-400 mb-4">
                    Подбираем и настраиваем релевантные ключевые слова для максимальной 
                    эффективности кампаний.
                </p>
                <ul class="space-y-2 text-sm text-gray-500">
                    <li>• Подбор ключевых слов</li>
                    <li>• Группировка по темам</li>
                    <li>• Минус-слова</li>
            ...
            <div class="service-card animate-on-scroll" style="animation-delay: 0.2s;">
                ...
                <h3 class="text-2xl font-bold mb-4 text-gradient">Объявления</h3>
                <p class="text-gray-400 mb-4">
                    Пишем продающие тексты объявлений, которые привлекают внимание 
                    и мотивируют к действию.
                </p>
                <ul class="space-y-2 text-sm text-gray-500">
                    <li>• Текстовые объявления</li>
                    <li>• Расширенные объявления</li>
                    <li>• A/B тестирование</li>
                    <li>• Адаптивные объявления</li>
                </ul>
            </div>
            ...
            <div class="service-card animate-on-scroll" style="animation-delay: 0.3s;">
                ...
                <h3 class="text-2xl font-bold mb-4 text-gradient">Аудитории</h3>
                <p class="text-gray-400 mb-4">
                    Настраиваем таргетинг на целевую аудиторию для повышения 
                    конверсии и снижения стоимости клика.
                </p>
                <ul class="space-y-2 text-sm text-gray-500">
                    <li>• Сегментация аудитории</li>
                    <li>• Ретаргетинг</li>
                    <li>• Похожие аудитории</li>
            ...
            <div class="service-card animate-on-scroll" style="animation-delay: 0.4s;">
                ...
                <h3 class="text-2xl font-bold mb-4 text-gradient">Оптимизация</h3>
                <p class="text-gray-400 mb-4">
                    Постоянно улучшаем показатели кампаний через анализ данных 
                    и внедрение лучших практик.
                </p>
                <ul class="space-y-2 text-sm text-gray-500">
                    <li>• Ежедневный мониторинг</li>
                    <li>• Корректировка ставок</li>
            ...
            <div class="service-card animate-on-scroll" style="animation-delay: 0.5s;">
                ...
                <p class="text-gray-400 mb-4">
                    Настраиваем отслеживание конверсий и предоставляем детальные 
...
<section class="py-20 bg-dark-surface">
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <p class="text-xl text-gray-400 max-w-3xl mx-auto">
                Реальные показатели эффективности рекламных кампаний
            </p>
        </div>
...
<section class="py-20">
    <div class="container mx-auto px-4 md:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <p class="text-xl text-gray-400 max-w-3xl mx-auto">
                Пошаговый процесс настройки и ведения рекламных кампаний
            </p>
        </div>
        ...
        <div class="max-w-4xl mx-auto space-y-8">
            <div class="flex flex-col md:flex-row gap-6 items-start animate-on-scroll">
                ...
                <div>
                    <h3 class="text-2xl font-bold mb-3 text-gradient">Анализ и стратегия</h3>
                    <p class="text-gray-400 leading-relaxed">
                        Изучаем ваш бизнес, целевую аудиторию и конкурентов. Определяем цели 
                        кампании, бюджет и ключевые метрики для отслеживания.
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-6 items-start animate-on-scroll" style="animation-delay: 0.1s;">
                ...
                <div>
                    <h3 class="text-2xl font-bold mb-3 text-gradient">Настройка кампаний</h3>
                    <p class="text-gray-400 leading-relaxed">
                        Создаем структуру кампаний, подбираем ключевые слова, пишем объявления 
                        и настраиваем таргетинг на целевую аудиторию.
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-6 items-start animate-on-scroll" style="animation-delay: 0.2s;">
                ...
                <div>
                    <h3 class="text-2xl font-bold mb-3 text-gradient">Запуск и тестирование</h3>
                    <p class="text-gray-400 leading-relaxed">
                        Запускаем кампании и проводим A/B тестирование объявлений. 
                        Собираем данные для дальнейшей оптимизации.
                    </p>
                </div>
            </div>
            ...
            <div class="flex flex-col md:flex-row gap-6 items-start animate-on-scroll" style="animation-delay: 0.3s;">
                ...
                <div>
                    <h3 class="text-2xl font-bold mb-3 text-gradient">Оптимизация и масштабирование</h3>
                    <p class="text-gray-400 leading-relaxed">
                        Постоянно анализируем результаты, корректируем ставки, улучшаем объявления 
                        и масштабируем успешные кампании для максимального ROI.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8 text-center">
        <div class="max-w-3xl mx-auto animate-on-scroll">
            ...
            <p class="text-xl text-gray-300 mb-12">
                Получите бесплатную консультацию и расчет бюджета для вашей кампании
            </p>
