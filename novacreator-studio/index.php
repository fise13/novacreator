    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div class="max-w-7xl mx-auto">
            <div class="text-center animate-on-scroll">
                <div class="text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] xl:text-[12rem] font-extrabold mb-6 leading-none tracking-tighter transition-all duration-300 hover:scale-105" style="color: var(--color-text);">
...
<!-- Скрипт для анимации счетчиков и параллакса -->
<script>
